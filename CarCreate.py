...
class Car:
    def __init__(self,name,m,CdA,ClA,P_max,mu_x,Rl,rr,gear_res,M_max,i):
    ...
    def Fdown(self,v,rho=1.016): #calculate vehicle downforce
    ...
    def Ftractive(self,v): 
        ...
        F_traction_limit = self.mu_x * (self.m * 9.81 + self.Fdown(v)) # maximum tractive force limited by tire friction 
...
Predefined_Cars = {
    'CTU24': {'name': 'CTU24', 'm': 300, 'CdA': 1.2, 'ClA': 5, 'P_max': 80, 'mu_x': 1.5, 'Rl': 0.2, 'rr': 0.015, 'gear_res': 0.001, 'M_max': 30, 'i': 12},
    'CTU25': {'name': 'CTU25', 'm': 250, 'CdA': 1.3, 'ClA': 6, 'P_max': 80, 'mu_x': 1.6, 'Rl': 0.2, 'rr': 0.015, 'gear_res': 0.001, 'M_max': 30, 'i': 12}
}
